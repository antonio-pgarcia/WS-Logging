...
public class HJ2AppHelper extends Object {
	...
	private static long get_threadcontextparent() {
		return( Thread.currentThread().getContextClassLoader().getParent().hashCode() );
	}
	...
	public static String get_AppName() {
		...
		if( m_objAppList == null ) return ( _DEFAULT_APPNAME );
                ...
                if( (m_strApplication= m_objAppList.get( get_threadcontextparent() )) != null )
